val greenPlastic = <ore:dyeGreen>;// <pneumaticcraft:plastic:10>;
val redPlastic = <ore:dyeRed>;// <pneumaticcraft:plastic:1>;
val bluePlastic = <ore:dyeBlue>;// <pneumaticcraft:plastic:12>;
val magentaPlastic = <ore:dyeMagenta>;// <pneumaticcraft:plastic:13>;
...
val aluminum = <ore:plateAluminum>.firstItem;
